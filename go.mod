module github.com/baetyl/baetyl-gateway

go 1.18

replace (
	github.com/chen-Leo/bacnet => github.com/baetyl/bacnet v1.0.2
	github.com/thinkgos/go-iecp5 => github.com/baetyl/go-iecp5 v1.0.0
)

require (
	github.com/256dpi/gomqtt v0.14.3
	github.com/baetyl/baetyl-gateway-sdk/sdk/golang v0.0.0-20231204080938-5fc7f3329690
	github.com/baetyl/baetyl-go/v2 v2.0.0-20231110071933-cbbe894cc7e5
